 ...
 */
function cogelectron_form_system_theme_settings_alter(&$form, FormStateInterface &$form_state, $form_id = NULL) {
  ...
  $form['cogelectron_example'] = [
  '#type'          => 'checkbox',
  '#title'         => t('cogelectron sample setting'),
  '#default_value' => theme_get_setting('cogelectron_example'),
